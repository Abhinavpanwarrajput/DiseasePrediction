...
# TESTING DATA
tr=pd.read_csv("D:/Health-A-Thon/DataSet/Testing.csv")
...
# TRAINING DATA
df=pd.read_csv("D:/Health-A-Thon/DataSet/Training.csv")
...
w2 = Label(root, justify=LEFT, text=" Disease Prediction From Symptoms By TEAM-20")
